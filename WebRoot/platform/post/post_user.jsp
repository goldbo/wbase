...
<%
	...
	List<ViewUserInfo> selList = wbaseUserService.findUserInfoByPostNo(postNo);
%>
<html:html lang="true">
<head>
	...
	<script type="text/javascript"
		src="<%=baseURL%>/dwr/interface/wbasePostUserService.js"></script>
...
if(cbox.length>0){
	...
	wbasePostUserService.updatePostUserByUserIds(selIds,postNo,function(bool){alert(bool==true?"设置成功!":"设置失败!");});
}
