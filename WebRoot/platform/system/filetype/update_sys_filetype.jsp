...
<body >
	<div align="center">
		<html:form action="/SysFiletypeAction.do?action=updateSysFiletype"
			...
			<table border="0" width="85%" id="table2">
				...
				<tr>
					...
					<td>
						<wbase:uploadImage propertyId="filePic" propertyName="filePic" propertyValue="${wbaseSysFiletypeForm.filePic }" rename="false" dirType="0" savePath="${wbaseSysFiletypeForm.savePath }"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<html:text property="fileRemark" name="wbaseSysFiletypeForm"></html:text>
					</td>
				</tr>
				...
				<tr>
					<td align="center" colspan="2" height="25">
						<hr>
						<html:hidden property="id" name="wbaseSysFiletypeForm"/>
