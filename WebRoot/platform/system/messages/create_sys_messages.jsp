...
<body>
	<div align="center">
		<html:form action="/SysMessagesAction.do?action=createSysMessages"
			styleId="wbaseSysMessagesForm" method="post">
...
<%--						<textarea id="msgContents" name="msgContents" rows="20" cols="65"></textarea>--%>
					</td>
				</tr>
				...
				<tr>
					<td align="center" colspan="2" height="25">
						...
						<input type="button" value="继续添加" class="button1"
							onclick="saveSysMessages('create');">
